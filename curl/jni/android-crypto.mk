CRYPTO_PATH=$(LOCAL_PATH)/../../openssl-android/crypto
...
LOCAL_CRYPTO_SRC_FILES := aes/aes_cbc.c \
  aes/aes_cfb.c \
  aes/aes_ctr.c \
  aes/aes_ecb.c \
  aes/aes_misc.c \
...
ifeq ($(TARGET_ARCH),arm)
	LOCAL_CRYPTO_SRC_FILES += $(arm_src_files)
	LOCAL_CFLAGS += $(arm_cflags)
else
	LOCAL_CRYPTO_SRC_FILES += $(non_arm_src_files)
endif
